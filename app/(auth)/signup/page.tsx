...
export default function SignupPage() {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6">
      ...
      <h1 className="text-2xl font-bold text-foreground">Inizia il vostro percorso</h1>
      <p className="mt-2 text-sm text-muted-foreground">Crea il vostro spazio privato</p>
